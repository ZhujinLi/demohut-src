...
let curRatios = [1, 0, 0, 0];
let ratioStep = [0, 0, 0, 0];
...
document.getElementById("globe").onclick = () => setTarget([1, 0, 0, 0]);
document.getElementById("equirectangular").onclick = () => setTarget([0, 1, 0, 0]);
document.getElementById("mercator").onclick = () => setTarget([0, 0, 1, 0]);
document.getElementById("winkeliii").onclick = () => setTarget([0, 0, 0, 1]);

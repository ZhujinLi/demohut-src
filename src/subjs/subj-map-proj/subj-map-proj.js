...
document.getElementById("tMercator").onclick = () => setTarget([0, 0, 0, 1, 0, 0]);
document.getElementById("winkeliii").onclick = () => setTarget([0, 0, 0, 0, 1, 0]);
document.getElementById("bonne").onclick = () => setTarget([0, 0, 0, 0, 0, 1]);
